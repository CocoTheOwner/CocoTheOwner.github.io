import {Email, readCsv} from "./csvParser.js";
import {MailGraph} from "./mailGraph.js";
...
class EdgeBundling {
  ...
  drawArcs(element) {
    ...
    let angles = [clusters.length];

    // Make sure canvas is reachable
    const canvas = document.getElementById("edgeBundling");
    if (canvas == null) {
